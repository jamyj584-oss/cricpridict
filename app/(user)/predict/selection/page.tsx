...
function PredictSelectionClient() {
  ...
  return (
    <main className="min-h-screen bg-[#0F1115] text-white flex flex-col pb-36">
      ...
      <div className="fixed bottom-[80px] left-0 right-0 max-w-md mx-auto p-4 z-[100] bg-gradient-to-t from-[#0F1115] via-[#0F1115]/95 to-transparent pointer-events-none">
