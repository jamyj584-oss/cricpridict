...
export default function CaptainSelectionClient() {
  ...
  return (
    <main className="min-h-screen bg-[#0F1115] text-white flex flex-col pb-24">
      ...
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-[#0F1115]/95 backdrop-blur-xl border-t border-white/5 grid grid-cols-2 gap-4 z-50">
        <button className="border border-white/20 bg-transparent text-white font-bold py-3.5 rounded-xl text-xs uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-white/5 active:scale-95 transition-all">
          <Layout size={16} className="text-accent" /> Team Preview
        </button>
        <button onClick={handleSaveTeam} className="bg-gradient-to-r from-[#7698FB] to-[#4B73E1] text-[#0F1115] font-bold py-3.5 rounded-xl text-xs uppercase tracking-widest flex items-center justify-center gap-2 shadow-lg shadow-accent/20 active:scale-95 transition-all">
